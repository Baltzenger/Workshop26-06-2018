...
<head>
    ...
    <body>
        <div id="content">
            ...
            <div id="banner">
                <p class="slogan">  "Toute le monde a une connaissances, qui mérite d'être partager"</p>
            </div>
                ...
                <p>
                    ...
                    comme tout le monde, vous avez des connaissances qui peuvent être utiles à tout un chacun 
                </p>
                <h1>Nos valeurs</h1>
                <div id="knowledge">
